<template>
  <div class="login">
    <form >
      ...
      <button class="loginSub" @click.prevent="login">登录<i class="fa-solid fa-spinner fa-spin" v-show="icon"></i></button>
    </form>
  </div>
</template>
...
<style scoped>
  ...
  @import '../assets/css/fontawesome-free-6.3.0-web/css/solid.css'
</style>